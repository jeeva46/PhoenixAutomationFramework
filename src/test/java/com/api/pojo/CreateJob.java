...
public class CreateJob {
	...
	public CreateJob(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id, int mst_oem_id,
	...
	public String toString() {
		return "CreateJob [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id=" + mst_platform_id
